...
export default function LaptopsAndPhones() {
  return (
    <div className="grid grid-cols-3 max-w-[100%] mx-auto gap-12 ">
      <Link
        href={"/category/laptop"}
        className="bg-white shadow-md group   bg-gradient-to-r from-blue-100 via-blue-300 to-cyan-500  border border-gray-200 rounded-md flex-grow p-4"
      >
        <p className="text-2xl font-semibold mb-6">Laptops</p>
